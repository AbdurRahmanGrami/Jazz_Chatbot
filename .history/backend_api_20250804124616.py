...
from llama3 import Llama3TogetherWrapper

llm = Llama3TogetherWrapper(api_key=os.getenv("TOGETHER_API_KEY"))
...
async def chat_endpoint(request: ChatRequest):
    ...
    try:
        result = chain.run({"message": query, "session_id": session_id, "email": email})
