...
insurance_file = "insurance_chunks.json"
devices_file = "devices.json"  # New devices JSON
...
# --- Helper: Load Devices ---
def load_device_documents(filepath: str) -> List[Document]:
    with open(filepath, "r", encoding="utf-8") as f:
        devices = json.load(f)
...
if __name__ == "__main__":
    ...
    documents.extend(load_device_documents(devices_file))  # Add devices here
